...
class PromptLearner(nn.Module):
    ...
    def forward(self, im_features, im_cls, target=None):  # [B,512] -> [B,5,512]
        ...
        if self.training:
            ...
            # loss_prompts = (1 - F.cosine_similarity(query_output * mask, target_embed * mask, dim=-1)).mean()
        else:
...
class Baseline_cattn_embedloss(BaseModel):
    def __init__(self, cfg, classnames=None):
        ...
        self.logger.info("Building Baseline_cattn_embedloss")
