...
CUDA_VISIBLE_DEVICES=0 WANDB_API_KEY=2a0ff77c64888b3bd539c7873069809fbfeb6059 WANDB_MODE=offline python /home/lijun07/code/CAPT/train_wandb_iter_val.py \
    ...
    --config-file /home/lijun07/code/CAPT/configs/trainers/Baseline_caption/vit_b16_multi_stream.yaml \
    DATASET.NUM_SHOTS ${SHOTS} OPTIM.MAX_ITER ${ITER} OPTIM.LR ${LR} SIMPLE_SEED True