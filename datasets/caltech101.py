import os
import pickle
from .basic import Benchmark, read_split, save_split, read_and_split_data, generate_fewshot_dataset, \
    subsample_classes, read_split_caption
...
class Caltech101(Benchmark):
    ...
    def __init__(self, cfg):
        ...
        # only train, val need to few-shots
        # test don't need few-shots
