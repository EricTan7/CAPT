...
def main(args):
    ...
    run = wandb.init(project=args.wandb_proj, config=cfg, tags=[f"abl_caption_{cfg.TRAINER.NAME.split('_')[-1]}"], dir='/data/wandb/0711')  # f"abl_caption_wo_{cfg.TRAINER.NAME.split('_')[-1]}"
