...
def main(args):
    ...
    run = wandb.init(project=args.wandb_proj, config=cfg, tags=[f"abl_caption_vitl_wo_{cfg.TRAINER.NAME.split('_')[-1]}"], dir='/data/wandb/0711')  # f"abl_caption_wo_{cfg.TRAINER.NAME.split('_')[-1]}"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--wandb-proj", type=str, default="AAAI24", help="project name of wandb"
    )
